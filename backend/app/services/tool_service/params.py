...
def yaml_defaults_for_tool_type(tool_type: ToolType) -> dict[str, Any]:
    ...
    by_name = {
        ...
        "Trail Striders": cfg.trail_striders.model_dump(mode="json"),
        "Expedition Drivetrain": cfg.expedition_drivetrain.model_dump(mode="json"),
        "Canyon Throttle": cfg.canyon_throttle.model_dump(mode="json"),
        "Overland Chassis": cfg.overland_chassis.model_dump(mode="json"),
