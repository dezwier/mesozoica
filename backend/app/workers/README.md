...
Sites are committed in batches of **50** (`PROGRESS_LOG_INTERVAL`). The Flutter map polls for new field sites at 5 s, 15 s, then every 60 s after an ensure request.
