...
Log lines use a unified format, e.g. `field_site_generate action=ensure_enqueued lat=… lon=… reason=resume missing=…`. Worker logs `action=worker_done generated=… total_in_radius=…`.
