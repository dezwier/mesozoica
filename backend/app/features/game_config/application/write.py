"""Publishing new game config revisions. Feature-owned implementation."""
...
from app.features.game_config.application.locked_paths import (
    GameConfigLocked,
    assert_locked_paths_unchanged,
)
from app.features.game_config.application.read import StoredConfig, read_active_config
...
def rollback_to_version(
    ...
    *,
    ...
    """
    from app.features.game_config.application.read import read_revision
