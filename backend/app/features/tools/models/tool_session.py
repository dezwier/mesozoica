"""Unified tool-card activation (one row per use). Owned by the tools feature."""
...
ACTION_KEY_TRAIL_STRIDERS = "trail_striders"
ACTION_KEY_EXPEDITION_DRIVETRAIN = "expedition_drivetrain"
ACTION_KEY_CANYON_THROTTLE = "canyon_throttle"
ACTION_KEY_OVERLAND_CHASSIS = "overland_chassis"
ACTION_KEY_NOCTURNE_LENS = "nocturne_lens"
ACTION_KEY_BRUSH_SCRIM = "brush_scrim"
ACTION_KEY_BLACKOUT_COVER = "blackout_cover"
