...
from app.features.media.application.dinosaur_images.sync import resolve_local_source_dir_for_sync
from app.features.ingestion.public import dino_name_match_clause
from app.features.media.application.fossil_images.sync import resolve_local_source_dir_for_sync as resolve_fossil_output_dir
...
from app.features.media.infrastructure.image_generation.client import short_generation_error
from app.features.media.infrastructure.image_generation.fossil_json import fossil_to_image_prompt_dict
