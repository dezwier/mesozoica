"""
Sync 15-minute past + forecast weather for cells with active field sites. Feature-owned implementation.
...
from app.features.weather.infrastructure.persist import sync_weather_for_active_cells
