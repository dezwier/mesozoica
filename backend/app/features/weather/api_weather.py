"""Ambient weather status for the player's location. Owned by the weather feature."""
...
from app.features.weather.infrastructure.persist import weather_series
from app.features.weather.infrastructure.service import cell_for, get_weather
