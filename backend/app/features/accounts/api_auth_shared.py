"""Shared auth endpoint helpers. Owned by the accounts feature."""
...
from app.features.accounts.infrastructure.firebase_auth import get_firebase_user_providers
from app.features.accounts.application.users import user_to_response
