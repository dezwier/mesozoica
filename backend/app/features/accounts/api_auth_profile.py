"""Auth profile endpoints. Owned by the accounts feature."""
...
from app.features.accounts.application.user_images import (
    delete_user_image_file,
    process_user_profile_image,
    save_user_image,
)
from app.features.accounts.application.users import (
    delete_user_account,
