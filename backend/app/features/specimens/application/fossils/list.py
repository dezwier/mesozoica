...
from app.features.media.public import (
    DINOSAUR_CURATED_MEDIA_PATH,
    FOSSIL_CURATED_MEDIA_PATH,
)
from app.features.sites.public import effective_site_type
...
def fossil_row_to_summary(
    ...
    *,
    ...
    from app.features.media.public import resolve_fossil_card_image_url
    from app.features.media.public import ORIGINAL_VERSION
