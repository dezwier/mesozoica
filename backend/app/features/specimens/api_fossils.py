"""Fossil read and status endpoints. Owned by the specimens feature."""
...
from app.features.specimens.application.fossils.list import fossil_row_to_summary, get_fossil_by_id, list_fossils
