"""Shared exact-token helpers used by knowledge chunking and rag prompting."""
...
class TokenizerError(RuntimeError, ValueError):
    """Raised when a tiktoken encoding cannot be loaded."""
...
def load_encoding(name: str) -> Encoding:
    """Load and cache a named tiktoken encoding."""
    try:
        import tiktoken
        ...
        raise TokenizerError(
            ...
            "during the image build and verify the configured encoding name."
        ) from exc
