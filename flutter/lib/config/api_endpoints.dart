...
class ApiEndpoints {
  ...
  static Uri siteIdentifyOptionsUri(int id) =>
      Uri.parse('${AppConfig.baseApiUrl}/api/v1/sites/$id/identify-options');

  static Uri siteIdentifyUri(int id) =>
      Uri.parse('${AppConfig.baseApiUrl}/api/v1/sites/$id/identify');
