  ...
  return _SkillParamGroups(
    skillParams: [
      ...
      _resolveScalarParam(
        ...
        paramKey: 'document_accuracy',
        skillId: 'field_survey',
        base: mp.documentAccuracy,
        levelEntries: cfg.levelModifiers['document_accuracy'],
        weatherTimeMods: cfg.weatherTimeModifiers['document_accuracy'],
        weatherTime: weatherTime,
        weatherTypeMods: cfg.weatherTypeModifiers['document_accuracy'],
        weatherType: weatherType,
        skillLevel: skillLevel,
        format: _ParamFormat.chance,
        clampUnit: true,
      ...
      _resolveScalarParam(
        label: 'Document speed',
        paramKey: 'document_speed',
        skillId: 'field_survey',
        base: mp.documentSpeed,
        levelEntries: cfg.levelModifiers['document_speed'],
        weatherTimeMods: cfg.weatherTimeModifiers['document_speed'],
        weatherTime: weatherTime,
        weatherTypeMods: cfg.weatherTypeModifiers['document_speed'],
        weatherType: weatherType,
        skillLevel: skillLevel,
    ...
    xpSources: [
      ...
      _resolveScalarParam(
        label: 'Explore 100m passively',
        paramKey: 'explore_100m_passively_xp',
        skillId: 'field_survey',
        base: cfg.explore100mPassivelyXp,
        levelEntries: cfg.levelModifiers['explore_100m_passively_xp'],
        weatherTimeMods: cfg.weatherTimeModifiers['explore_100m_passively_xp'],
        weatherTime: weatherTime,
        weatherTypeMods: cfg.weatherTypeModifiers['explore_100m_passively_xp'],
        weatherType: weatherType,
        skillLevel: skillLevel,
        format: _ParamFormat.xp,
        clampUnit: false,
