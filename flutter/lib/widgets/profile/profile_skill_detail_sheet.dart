  ...
  return _SkillParamGroups(
    skillParams: [
      ...
      _resolveScalarParam(
        ...
        paramKey: 'documentation_accuracy',
        skillId: 'field_survey',
        base: mp.documentationAccuracy,
        levelEntries: cfg.levelModifiers['documentation_accuracy'],
        weatherTimeMods: cfg.weatherTimeModifiers['documentation_accuracy'],
        weatherTime: weatherTime,
        weatherTypeMods: cfg.weatherTypeModifiers['documentation_accuracy'],
        weatherType: weatherType,
        skillLevel: skillLevel,
        format: _ParamFormat.chance,
        clampUnit: true,
